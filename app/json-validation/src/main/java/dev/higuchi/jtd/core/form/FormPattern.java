...
public enum FormPattern {
    ...
    OPTIONAL_PROPERTIES(new boolean[]{false, false, false, false, false, true, false, false, false, false}),
    PROPERTIES_AND_OPTIONAL_PROPERTIES(new boolean[]{false, false, false, false, true, true, false, false, false, false}),
    PROPERTIES_AND_ADDITIONAL_PROPERTIES(new boolean[]{false, false, false, false, true, false, true, false, false, false}),
    OPTIONAL_PROPERTIES_AND_ADDITIONAL_PROPERTIES(new boolean[]{false, false, false, false, false, true, true, false, false, false}),
    PROPERTIES_AND_OPTIONAL_PROPERTIES_AND_ADDITIONAL_PROPERTIES(new boolean[]{false, false, false, false, true, true, true, false, false, false}),
    ...
    public static Optional<FormPattern> from(JTDSchema schema) {
        boolean[] forms = {schema.hasRef(), schema.hasType(), schema.hasEnum(), schema.hasElements(), schema.hasProperties(), schema.hasOptionalProperties(),
                schema.hasAdditionalProperties(), schema.hasValues(), schema.hasDiscriminator(), schema.hasMapping()};
