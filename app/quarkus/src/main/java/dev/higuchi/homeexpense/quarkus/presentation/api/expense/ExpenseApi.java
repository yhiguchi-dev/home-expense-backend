...
import dev.higuchi.homeexpense.quarkus.application.usecase.expense.ExpenseUpdateService;
...
public class ExpenseApi implements LinkHeaderCreatable {
  ...
  public Response get(
    ...
    responseBuilder.header(
        "Link",
        create(uriInfo.getAbsolutePath(), criteria.pagination(), expenseSummary.totalCount()));
