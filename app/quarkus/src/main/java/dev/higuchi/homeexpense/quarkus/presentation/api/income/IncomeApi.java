...
import dev.higuchi.homeexpense.quarkus.application.usecase.income.IncomeUpdateService;
...
public class IncomeApi implements LinkHeaderCreatable {
  ...
  public Response get(
    ...
    responseBuilder.header(
        "Link",
        create(uriInfo.getAbsolutePath(), criteria.pagination(), incomeSummary.totalCount()));
