...
public class IncomeSummaryDataSource implements IncomeSummaryRepository {
  ...
  public IncomeSummaryDataSource(DataSource dataSource) {
  ...
  public IncomeSummary find(IncomeSummaryCriteria criteria) {
    ...
    try (Connection conn = dataSource.getConnection();
      ...
      try (ResultSet rs = ps.executeQuery()) {
        ...
        return new IncomeSummary(totalCount, list);
      }
  ...
  private void appendDateRange(
      IncomeSummaryCriteria criteria, StringBuilder sql, List<Object> params) {
